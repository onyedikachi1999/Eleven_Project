...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { name: 'Read community discussions', included: true },
      { name: 'Create community topics & discussions', included: false },
  ...
  },
  {
    ...
    price: '₦5,000',
    period: 'month',
    description: 'Create communities, lead prayer circles, and join discussions.',
    icon: Star,
    color: '#8B6914',
    borderColor: '#E8D5C0',
    ...
    badge: 'Most Popular',
    features: [
      { name: 'Full access to Testimony Hub', included: true },
      { name: 'Create community discussions & post topics', included: true },
      { name: 'Create & lead custom prayer circles', included: true },
      { name: 'Post messages & media on circle walls', included: true },
      { name: 'Reply & engage in all forum discussions', included: true },
      { name: 'Schedule & host live joint prayer sessions', included: false },
  ...
  },
  {
    ...
    price: '₦15,000',
    period: 'month',
    description: 'Schedule & host live prayer sessions, create communities & circles.',
    icon: Crown,
    color: '#6B3A5A',
    borderColor: '#E8D5E0',
    ...
    features: [
      ...
      { name: 'Live audio broadcasting & room moderator tools', included: true },
      { name: 'Post messages & media on circle walls', included: true },
