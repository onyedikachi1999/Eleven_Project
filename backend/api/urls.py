...
urlpatterns = [
    ...
    path('admin/users/create/', views.AdminViewSet.as_view({'post': 'create_user'}), name='admin_create_user'),
    path('admin/users/<int:user_id>/plan/', views.AdminViewSet.as_view({'post': 'update_user_plan'}), name='admin_update_user_plan'),
